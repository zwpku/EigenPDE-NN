...
class md_data_loader() :
    def __init__(self, Param, training_data=True) :
        ...
        self.md_data_filename_prefix = Param.md_dcddata_filename_prefix
        ...
        if training_data == True :
            ...
            self.md_data_path = Param.md_dcddata_path
        else :
            self.data_filename_prefix = Param.data_filename_prefix_validation
            self.md_data_path = Param.md_dcddata_path_validation

        print ('Paths: %s/%s' % (self.md_data_path, self.md_data_filename_prefix) )
    ...
    def load_angles_from_colvar_traj(self) :
        ...
        colvar_traj_filename = '%s/%so.colvars.traj' % (self.md_data_path, self.md_data_filename_prefix)
    ...
    def weights_of_colvars_by_pmf(self) :
        ...
        colvar_pmf_filename = '%s/%so.pmf' % (self.md_data_path, self.md_data_filename_prefix)
