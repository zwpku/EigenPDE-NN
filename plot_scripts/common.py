...
working_dir_list = ['working_dir_namd_ABF7e-1-800ns-MultiFeatures', 'working_dir_1d_beta1.4-rerun', 'working_dir_2d_MetastableRadius', 'working_dir_5d_MetastableRadius', 'working_dir_20d_MetastableRadius', 'working_dir_100d_MetastableRadius']
