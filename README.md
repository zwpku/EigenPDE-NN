...
#### 3. Generate trajectory data
  ...
  Run the script [main.py](test_ex1_50d/main.py) by `python ./main.py`, and choose task 0 from input.

#### 3. Train neural networks

  Run the script [main.py](test_ex1_50d/main.py) by `python ./main.py`, and choose task 3 from input.
